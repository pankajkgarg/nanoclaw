...
which remotion 2>/dev/null && echo "remotion: available" || echo "remotion: not installed"
which youtube-analyze 2>/dev/null && echo "youtube-analyze: available" || echo "youtube-analyze: not installed"
